...
## Комментарий
В логах что грузил только под конец увидел баг, что стояла обрезка в 150 символов при записи в json. В гите уже лежит исправленный код, надеюсь это не повлияет
